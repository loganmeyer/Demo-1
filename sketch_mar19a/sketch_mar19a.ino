...
float  goalDistance = 8;            // Desired linear distance traveled, in ft (CHANGE PER RUN)
...
#define diametermod 0.5008 // More accurate diameter based on testing                  // 10ft: 0.5, 8ft: 0.5008
